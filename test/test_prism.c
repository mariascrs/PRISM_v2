...
static int test_prism(unsigned long long in_msglen) {
    ...
    res = prism_sign(sig, &smlen, msg, in_msglen, sk);
    if (res != 0) {
        res = -1;
        goto err;
    }
    ...
    res = prism_open(msg_open, &msglen, sig, smlen, pk);
...
#ifndef NDEBUG
    printf("----------------------------------------------------------------------------------------------\n");
    printf("WARNING: THIS SHOULD FAIL, SO IGNORE ERROR MESSAGES!\n");
...
printf("----------------------------------------------------------------------------------------------\n");
    printf("----------------------------------------------------------------------------------------------\n");
    printf("Verification is working!\n");
    printf("----------------------------------------------------------------------------------------------\n\n");
#endif
    ...
    res = prism_sign(sig, &smlen, sig, in_msglen, sk);
    if (res != 0) {
        res = -1;
        goto err;
    }
