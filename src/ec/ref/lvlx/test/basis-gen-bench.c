...
bench_basis(int iterations)
{
    printf("\n-------------------------------------------------------------------------------------"
           "-------------------\n\n");
    printf("Benchmarking E[2^n] basis generation for " STRINGIFY(PRISM_VARIANT) ": \n\n");
    bench_basis_generation(TORSION_EVEN_POWER, iterations);
    bench_basis_generation(128, iterations);

    printf("\nBenchmarking E[2^n] basis generation with hint for " STRINGIFY(PRISM_VARIANT) ": \n\n");
...
{
    int iterations = 100 * PRISM_TEST_REPS;
    int help = 0;
