...
if (NOT DEFINED PRISM_BUILD_TYPE)
    set(PRISM_BUILD_TYPE "ref")
endif()

if (RADIX EQUAL 32)
    if (${PRISM_BUILD_TYPE} MATCHES "broadwell")
    ...
    elseif(${PRISM_BUILD_TYPE} MATCHES "ref")
...
if (NOT DEFINED PRISM_TEST_REPS)
    set(PRISM_TEST_REPS 10)
endif()

add_compile_definitions(PRISM_TEST_REPS=${PRISM_TEST_REPS})
