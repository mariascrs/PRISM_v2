if(EXISTS ${CMAKE_CURRENT_SOURCE_DIR}/generic)
    set(LIB_${CCSD_NAME_UPPER} prism_${CCSD_NAME}_generic CACHE INTERNAL "LIB")
    ...
    FOREACH(SVARIANT ${SVARIANT_S})
        string(TOUPPER ${SVARIANT} SVARIANT_UPPER)
        string(TOLOWER ${SVARIANT} SVARIANT_LOWER)
        set(LIB_${CCSD_NAME_UPPER}_${SVARIANT_UPPER} prism_${CCSD_NAME}_${SVARIANT} CACHE INTERNAL "LIB")
